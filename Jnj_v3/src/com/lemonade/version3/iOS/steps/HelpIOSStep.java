...
import com.lemonade.version3.iOS.pages.HelpPageIOS;
...
public class HelpIOSStep {
	...
	@QAFTestStep(description="user verifies OTR Mobile App Page")
	public void userVerifiesOTRMobileAppPage() {
		helpPage.verifyOTRMobilePage();
	}
