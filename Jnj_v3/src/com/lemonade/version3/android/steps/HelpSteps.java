...
import com.lemonade.version3.android.pages.HelpPageAndroid;
...
public class HelpSteps {
	...
	@QAFTestStep(description = "user verifies about me help page")
	public void verifiesAboutMePage() {
		helpPageAndroid.verifiesAboutMeHelpPage();
	}

	@QAFTestStep(description = "user verifies About Me sub help page")
	public void verifiesAboutMeSubMenuPage() {
		helpPageAndroid.verifiesAboutMeSubMenuHelp();
	}
